create or replace NONEDITIONABLE procedure simulacion_3 
is
Begin
    Declare
    ...
    --Aca asignamos el grupo al evento 
            ...
            dbms_output.put_line('ERROR, en el sistema no existe ninguna sucursal....Por favor haga la compra de una con la simulacion 7'); 
        end if;
    end; 
end;